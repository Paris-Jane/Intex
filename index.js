...
// LOGIN PAGE:
    ...
    app.post("/login", async (req, res) => {
        ...
        try {
            ...
            if (user) {
            // pick the correct id field (user_id for your schema, fallback to id)
    ...
    app.get("/participants", async (req, res) => {
        try {
            ...
            if (searchValue && searchColumn) {
                ...
                if (term) {
                    if (searchColumn === "full_name") { // for full name, do this:
...
// SURVEY MAINTENANCE PAGE:
    ...
    app.get('/surveys', async (req, res) => {
        ...
        let {searchColumn,searchValue,eventNames,satisfaction,usefulness,instructor,recommendation, overall, nps, sortColumn, sortOrder,} = req.query;
